    ...
    <div id="slider1" class="rev_slider" data-version="5.0">
        <ul>
            ...
            <li data-index="rs-1" data-transition="random" data-slotamount="7" data-easein="default"
                data-easeout="default" data-masterspeed="1000" data-thumb="images/bg/2.jpg" data-rotate="0"
                ...
                <!-- MAIN IMAGE -->
                <img src="<?php echo e(asset ("public/user/images/bg/2.jpg")); ?>" alt="" data-bgposition="50% 90%"
                ...
                <div class="hidden-xs  tp-caption tp-resizeme rs-parallaxlevel-0 text-uppercase"
                     ...
                     style="z-index: 6; letter-spacing:-3px; white-space: nowrap;"><span class="text-thm">রক্ত   </span><span
                            class="text-white">কেন দান করবেন?  </span>
                </div>
                ...
                <div class="hidden-xs tp-caption BigBold-SubTitle tp-resizeme rs-parallaxlevel-0"
                     ...
                     data-basealign="slide"
                     data-responsive_offset="on"
                     style="z-index: 7;"><span class="text-white text-white-cap">কেন দান করবেন?    </span>
                </div>
            ...
            <li data-index="rs-2" data-transition="random" data-slotamount="7" data-easein="default"
                data-easeout="default" data-masterspeed="1000" data-thumb="images/bg/3.jpg" data-rotate="0"
                data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo e(asset ("public/user/images/bg/3.jpg")); ?>" alt="" data-bgposition="center center"
                     data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="hidden-xs tp-caption tp-resizeme rs-parallaxlevel-0 text-uppercase"
                     ...
                     data-basealign="slide"
                     data-responsive_offset="on"
                     style="z-index: 6; white-space: nowrap;"><span class="text-thm">রক্ত</span> <span
                            class="text-white">কারা দান করবেন?
</span>
                </div>
                ...
                <div class="hidden-xs tp-caption BigBold-SubTitle tp-resizeme text-white rs-parallaxlevel-0"
                     ...
                     data-basealign="slide"
                     data-responsive_offset="on"
                     style="z-index: 7; min-width: 570px; max-width: 570px; max-width: 60px; max-width: 60px; white-space: normal;">
            ...
            <li data-index="rs-3" data-transition="random" data-slotamount="7" data-easein="default"
                data-easeout="default" data-masterspeed="1000" data-thumb="images/bg/4.jpg" data-rotate="0"
                data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo e(asset ("public/user/images/bg/4.jpg")); ?>" alt="" data-bgposition="top center"
                     data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="hidden-xs tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                     ...
                     data-basealign="slide"
                     data-responsive_offset="on"
                     style="z-index: 6; white-space: nowrap;"><span class="text-thm">রক্ত </span> দানে সাবধানতা
                </div>
...
<div class="bs-docs-header" style="background-color: red; margin-bottom: 80px">
    <div class="container"><h1>রক্তদাতা খুজুন </h1>
        <div class="col-md-8">
        <form class="form-horizontal" action="<?php echo e(url('/search-donor')); ?>" method="post">
            <div class="input-group" style="margin-bottom: 20px">
                ...
                <span class="input-group-addon">
                    <a href="<?php echo e(url('/search-donor')); ?>" target="submit"> <i class="fa fa-search"> </i> 
            </div>
        </form>
        </div>
        <div class="col-md-4">
          <a class="form-control btn btn-register-danger" href="#"> নিবন্ধন  </a> 
        </div>
        <br>
...
</div><?php /**PATH C:\laragon\www\bloodd\resources\views/user/bannercontainer.blade.php ENDPATH**/ ?>