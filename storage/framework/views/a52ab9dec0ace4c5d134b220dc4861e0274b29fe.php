    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title text-center text-uppercase">Report</h3>
                <div class="pull-right">
                    <a class="btn btn-xs btn-success" href="greadingSystem.php?add=yes"><i class="fa fa-plus"> </i> Add New</a>
                    <a class="btn btn-xs btn-success" href="greadingSystem.php"><i class="fa fa-tasks"> </i> View</a>
