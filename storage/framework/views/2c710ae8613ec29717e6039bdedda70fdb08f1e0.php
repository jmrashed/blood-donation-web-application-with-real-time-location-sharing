                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box box-info">
                                        ...
                                        <!-- form start -->
                                        <?php echo Form::open(['route'=>'addAdmin.store', 'method'=>'post', 'files'=>'true','class' => 'form-horizontal']); ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <a class="btn btn-success pull-right" href="<?php echo e(url('/admin?type=add&value=yes')); ?>"><i class="fa fa-plus"></i> Add Admin</a>
