...
<div class="footer-call-to-action">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 sm-text-center form-group">
                <p align="center" style="padding-bottom: 20px">Find out where are you want to donate blood </p>

                <form action="" class="form-horizontal" method="post">
                    <div class="input-group col-md-12 pull-center">
                        <input type="text" class="form-control" placeholder="Search for...">
                        <span class="input-group-btn">
                            <button class="btn btn-secondary btn-danger" type="button">Search</button>
                        </span>
                    </div>
                </form>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 latest-post col-md-3">
                <div class="footer-widget latest-post">
                    <h4 class="title">Give Blood</h4>
                    <hr>
                    <ul>
                        <li>
                            <h2 style="font-family:'Times New Roman', Times, serif; ">+8801734446514</h2>
                            <span>Call for blood Donate</span>

                            <p>Call for any emergency</p>
                            <h2 style="font-family:'Times New Roman', Times, serif; ">+8801734446514</h2>
                            <p>Or get any help</p>
                            <a href="#" class="btn btn-lg " style="border: 1px solid white;">Sign Up</a>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="footer-widget contact-widget">
                    ...
                    <hr>
                    <form action="https://demo.servehuman.theme.spidertrixcons.net/submit.php" class="contact-form"
                        id="footer-cf">
...
<div class="footer-bottom">
    <div class="container">
        <div class="col-md-12 col-xs-12">
            <h1>Lo<small>GO</small></h1>
            <hr>
        </div>
        <div class="col-xs-10 col-md-10">
            <span>© 2017 Blood Donation - ALL RIGHTS RESERVED</span> <a href="#">Terms and Conditions</a> | <a
                href="#">Blood Donation Policy</a>
        </div>
    </div>
</div>
                ...
                <div class="donation-form-outer">
                    <form action="#" method="post">
                        ...
                        <div class="form-portlet">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group  col-xs-12 padd-top-20">
                                    <input type="text" placeholder="Other Amount" value=""
                                        name="other-amount">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-portlet">
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    ...
                                    <input type="text" required="" placeholder="Card Number" value=""
                                        name="name">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    <div class="field-label">Security Code (CVC) <span class="required">*</span></div>
                                    <input type="text" required="" placeholder="Security Code" value=""
                                        name="name">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    <div class="field-label">Name <span class="required">*</span></div>
                                    <input type="text" required="" placeholder="First Name" value=""
                                        name="name">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    ...
                                    <input type="text" required="" placeholder="Phone" value=""
                                        name="name">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    <div class="field-label">Address <span class="required">*</span></div>
                                    <input type="text" required="" placeholder="Address 1" value=""
                                        name="name">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    ...
                                    <input type="text" required="" placeholder="Zip Code" value=""
                                        name="name">
                                </div>
                                <hr>
                        ...
                        <div class="form-portlet">
                            ...
                            <div class="payment-option-logo"><img alt=""
                                    src="<?php echo e(asset('public/user/images/resources/payment-logos.png')); ?>"
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-portlet">
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                    <div class="field-label">Email <span class="required">*</span></div>
                                    <input type="text" required="" placeholder="Email" value=""
                                        name="email">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-xs-12">
...
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.actions.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.carousel.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.kenburn.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.layeranimation.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.migration.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.navigation.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.parallax.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.slideanims.min.js')); ?>"></script>
<script type="text/javascript"
    src="<?php echo e(asset('public/user/revolution/js/extensions/revolution.extension.video.min.js')); ?>"></script>
<!-- thm custom script -->
...
<?php /**PATH C:\laragon\www\bloodd\resources\views/user/footer.blade.php ENDPATH**/ ?>