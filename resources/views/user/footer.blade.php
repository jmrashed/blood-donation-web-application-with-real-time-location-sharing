   ...
   <!--Footer div-->
            ...
            <h2 class="">Contact Us</h2>
                ...
                <div class="col-sm-6 latest-post col-md-3">
                    <div class="footer-widget latest-post">
                        <h4 class="title">Give Blood</h4><hr>
                        <ul>
                            <li> 
                                    <h1>01711 090909</h1>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="footer-widget contact-widget">
                        <h4 class="title">Contact Form</h4><hr>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <span>© 2017 Blood Donation - ALL RIGHTS RESERVED</span> <a href="#">Terms and Conditions</a> |  <a href="#">Blood Donation Policy</a>
            </div>
        </div>
    </div>
